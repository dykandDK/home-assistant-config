...
const prepareTemplateStyles = (renderedDOM, template, scopeName) => {
  ...
  Object(_modify_template_js__WEBPACK_IMPORTED_MODULE_1__["insertNodeIntoTemplate"])(template, condensedStyle, content.firstChild); // Note, it's important that ShadyCSS gets the template that `lit-html`
...
const render = (result, container, options) => {
  ...
  /* Node.DOCUMENT_FRAGMENT_NODE */
  && !!container.host && result instanceof _template_result_js__WEBPACK_IMPORTED_MODULE_5__["TemplateResult"]; // Handle first render to a scope specially...
...
/* eslint no-console: 0 */
console.info(`%c  OUR_GROCERIES-CARD   \n%c  Version ${_package_json__WEBPACK_IMPORTED_MODULE_2__.version}      `, "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray");


class OurGroceriesCard extends lit_element__WEBPACK_IMPORTED_MODULE_1__["LitElement"] {
    ...
    return lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`
      <tr>
        <td colspan='2'>
          ...
          ${this.config.show_crossed_off ? lit_element__WEBPACK_IMPORTED_MODULE_1__["html"]`
              <ul>
